...
class ProgressBar:
    ...
    def __init__(self):
        ...
        self.timer = gobject.timeout_add (0, progress_timeout, self)
...
if __name__ == "__main__":
	...
	counter = 0
	#while (counter < 1000):
	#	packets = UDPSock.recvfrom(buffer)
	#	counter += 1
	#	print counter
	print "\n"
	print "Success!"
	...
	print "\n"
	#print "Waiting on 1000 messages...."
	...
	packet, address = UDPSock.recvfrom(buffer)
	
	#parts = int(packet)
	
	print "Waiting on " + packet + " messages...."
